...
import MintTurtleModal from '@/components/modals/MintTurtleModal'
...
const Page = ({ docId, cardano: cardanoAddress, solana: solanaAddress }: PageProps) => {
  ...
  const [done, setDone] = useState(!!cardanoAddress && !!solanaAddress && cardano.connected && solana.connected)
          ...
          <div>
            <div className='my-2 flex'>
              <Button
                ...
                onClick={() => toggleModal('mintTurtle')}
              />
              <Button
                label='Mint Sidekick'
                colors='bg-green-500 border-green-400 [box-shadow:0_10px_0_0_#276749,0_15px_0_0_#27674941] active:[box-shadow:0_0px_0_0_#276749,0_0px_0_0_#27674941]'
            ...
            ) : openModals['mintTurtle'] ? (
              <MintTurtleModal isOpen={openModals['mintTurtle']} onClose={() => toggleModal('mintTurtle')} />
